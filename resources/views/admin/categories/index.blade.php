...
<style>
    ...
    .categories-page .table-scroll {
        overflow-x: auto;
        -webkit-overflow-scrolling: touch;
    }
</style>

<div class="categories-page min-h-screen bg-gray-100 py-8">
    <div class="w-full px-4 md:px-6 lg:px-8">

        <div class="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
                <h1 class="text-[30px] font-bold leading-tight text-gray-900">Categories</h1>
                <p class="mt-1 text-[15px] text-gray-500">Manage product categories</p>
            </div>
                ...
                <table class="min-w-full">
                    <thead class="bg-gray-50">
                        <tr class="border-b border-gray-200">
                            <th class="px-6 py-4 text-left text-[14px] font-semibold uppercase tracking-wide text-gray-600">Name</th>
                            <th class="px-6 py-4 text-left text-[14px] font-semibold uppercase tracking-wide text-gray-600">Parent</th>
                    ...
                    <tbody class="bg-white">
                        @forelse($categories as $category)
                            <tr class="border-b border-gray-100 transition hover:bg-gray-50">
                                <td class="px-6 py-4">
                                    <div class="text-[15px] font-semibold text-gray-900">{{ $category->name }}</div>
                                    <div class="mt-1 text-[13px] text-gray-500">ID: {{ $category->id }}</div>
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-10 text-center text-[15px] text-gray-500">
                                    No categories found.
                                </td>
                            </tr>
                        @endforelse
