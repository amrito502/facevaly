...
@section('content')
<style>
    .product-edit-page { font-size: 16px !important; }
</style>

<div class="product-edit-page min-h-screen bg-gray-100 py-8">
    <div class="w-full px-4 md:px-6 lg:px-8">
        <div class="mx-auto ">
            <div class="mb-6">
                <h1 class="text-[30px] font-bold leading-tight text-gray-900">Edit Product</h1>
                <p class="mt-1 text-[15px] text-gray-500">Update product, attributes and variants</p>
            </div>
